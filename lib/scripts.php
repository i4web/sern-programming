...
function i4web_scripts() {
  wp_enqueue_style('i4web_main', get_template_directory_uri() . '/assets/css/main.min.css', false, '51ef2446667e4eee7adbfce273e4ad1d');
  ...
  wp_register_script('i4web_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array(), '3975266fec2a33c078418ead22fbee13', true);
